...
* [Instantsearch](widgets/instantearch.md)
* [Breadcrumb](widgets/breadcrumb.md)
* [ClearAll](widgets/clear-all.md)
* [CurrentRefinedValues](widgets/current-refined-values.md)
* [HierarchicalMenu](widgets/hierarchical-menu.md)
* [Highlight](widgets/highlight.md)
* [Hits](widgets/hits.md)
* [HitsPerPageSelector](widgets/hits-per-page-selector.md)
...
* [SortBySelector](widgets/sort-by-selector.md)
